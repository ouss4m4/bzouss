    ...
    <div className="container">
      ...
      <div className="flex flex-row flex-wrap justify-center items-center gap-12">
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={tsLogo} />
          <span className="block pt-4">Typescript</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={angularLogo} />

          <span className="block pt-4">Angular</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={reactLogo} />
          <span className="block pt-4">React</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={gatsbyLogo} />
      ...
      <div className="flex flex-row flex-wrap justify-center items-center gap-12">
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={nodeLogo} />
          <span className="block pt-4">Node</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={expressLogo} />
          <span className="block pt-4">Express</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={mongodbLogo} />
      ...
      <div className="flex flex-row flex-wrap justify-center items-center gap-12">
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={fireLogo} />
          <span className="block pt-4">Firebase</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={netlifyLogo} />
          <span className="block pt-4">Netlify</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={awsLogo} />
      ...
      <div className="flex flex-row flex-wrap justify-center items-center gap-12">
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={nativescriptLogo} />
          <span className="block pt-4">NativeScript</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={flutterLogo} />
      ...
      <div className="flex flex-row flex-wrap justify-center items-center gap-12">
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={electronLogo} />
          <span className="block pt-4">Electron</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={vsLogo} />
          <span className="block pt-4">VSCode</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={webpackLogo} />
          <span className="block pt-4">WebPack</span>
        </div>
        <div className="text-center w-20 md:w-32">
          <img className="w-20 h-20 md:w-32 md:h-32" src={gitLogo} />
